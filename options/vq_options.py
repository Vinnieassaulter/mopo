...
def arg_parse(is_train=False):
    ...
    ## dataloader
    parser.add_argument('--dataset_name', type=str, default='soma', help='dataset directory')
    parser.add_argument('--n_max_markers', type=int, default=53, help='max number of markers')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size')
    parser.add_argument('--window_size', type=int, default=50, help='training motion length')
